...
// MARK: - REMOVED: v0.9 §5.W.5 设备管理 / 添加新设备 (DELETED v1.0.1)
//
// The multi-device pairing subsystem (QR / 6-digit code generation, device
// list, revoke) is gone in v1.0.1 — auth is a single fixed shared API_TOKEN
// the author hand-enters in the Connection form on both macOS and iOS. The
// DeviceManagementSection / AddDeviceDialog views, DeviceStore, DevicePairView,
// and the four /auth/* pairing endpoints were all removed together.
#endif
